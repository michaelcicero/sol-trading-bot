...
class TokenTrader:
    ...
    async def get_token_price(self):
        """Get token price and track OHLC data"""
        try:
            params = {
                "inputMint": SOL_MINT,
    ...
    async def trading_strategy(self):
        """Enhanced strategy with ATR-based dynamic thresholds"""
        while True:
            try:
